...
describe("DataStatus", () => {
  it("renders persisted sync status details", () => {
    render(
      <DataStatus
        status={{
          quote: { area: "quote", status: "ok", source: "eastmoney-on-exchange-quote", dataDate: "2026-06-09", itemCount: 5, freshItemCount: 1, cachedItemCount: 4, updatedAt: "2026-06-10T09:30:00.000Z" },
